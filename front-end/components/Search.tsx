...
<div className="container relative left-0 z-50 flex w-3/4 h-auto md:h-full ">
                            <div className="relative flex items-center w-full h-full lg:w-64 group">
                                ...
                                <input type="text" className=" input input-bordered block w-full py-1.5 pl-10 pr-4 leading-normal rounded-2xl   ring-opacity-90 bg-gray-100 dark:bg-gray-800 text-gray-400 aa-input" placeholder="Search"/>
